...
public class MainQueue {
      ...
      static LinearArrayQueue linearQueue = new  LinearArrayQueue();
     static CQueue cQueue = new CQueue();
    ...
    public static  void operationOfCQueue() {
        ...
        switch (opQueue) {
            case 1:
                linearQueue.Enqueue(sc.nextInt());
                break;
            case 2:
                linearQueue.Dequeue();
                break;
            ...
            case 5:
                ...
                break;
            case 6:
                linearQueue.removeItem(sc.nextInt());
                break;
            case 7:
                linearQueue.display();
                break;
